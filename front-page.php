        ...
        <div class="latest__wrapper">
          ...
          <div class="card__md">
            ...
            <div class="card__md__content">
              <ul><small><?php echo get_the_date('M d, Y'); ?></small></li>
    ...
    <section class="feature">
      ...
      <div class="container">
        <div class="feature__img">
          <picture>
            <source src="<?php echo get_template_directory_uri()?> ./img/img-9-sm.jpg" media="(max-width:719px)" />
            <source src="<?php echo get_template_directory_uri()?> ./img/img-9.jpg" media="(min-width:720px)" />
            <img src="<?php echo get_template_directory_uri()?> ./img/img-9.jpg" alt="blog-img" class="lazy" />
          </picture>
        </div>
      </div>
